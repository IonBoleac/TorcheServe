...
class MNISTDigitClassifier(ImageClassifier):
    ...
    def initialize(self, context):
        ...
        dim1 = Dimension(name="MyName", value="MNIST")
        dim2 = Dimension(name="MyLevel", value="Level1")
        


        # create new metrics
        metric = metrics.add_metric(name="NumberOfPredictions", metric_type=MetricTypes.COUNTER, value=0, unit="count", dimensions=[dim1, dim2])
