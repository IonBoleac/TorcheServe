...
# torch-model-archiver --model-name logreg --version 2.0 --handler ./models_project/logreg/logreg_handler.py --model-file ./models_project/logreg/logreg_model.py --serialized-file ./models_project/logreg/logreg_parameters.pt --export-path ./model_store/ -f --requirements-file ./models_project/logreg/logreg_requirements.txt --config-file ./models_project/logreg/logreg_config.yaml
